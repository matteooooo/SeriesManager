...
Imports log4net
Public Class table_HIS_SRT_FILES
    Const TABLE_NAME = "HIS_SRT_FILES"
    ...
    Shared Sub addFakeFiles()
        ...
        Dim cmd As OleDbCommand
        cmd = New OleDbCommand("insert into " & TABLE_NAME & " (FilePath,FileName,SerieName,SerieSeason,SerieEpisode,folder) select filepath,filename,serieName,serieSeason,serieEpisode,'Standard' from HIS_ADDED_FILES where filename like '%.srt%'", DBConnection.getConnection())
        Try
            cmd.ExecuteNonQuery()
